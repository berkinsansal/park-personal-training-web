  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        <Link
          href={`/${locale}/contact`}
          className="px-8 py-3 bg-amber-400 text-zinc-950 font-bold rounded-lg hover:bg-amber-300 transition-colors text-sm uppercase tracking-wider"
        >
          {tCta('startNow')}
        </Link>
        {phone && (
          <a
            ...
            className="px-8 py-3 border border-green-600 text-green-600 font-bold rounded-lg hover:bg-green-700/10 transition-colors text-sm uppercase tracking-wider inline-flex items-center gap-2"
          >
