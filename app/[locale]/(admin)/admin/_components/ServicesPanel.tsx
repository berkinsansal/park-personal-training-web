...
function ServiceForm({ t, defaults, onSubmit, onCancel, label, pendingOp }: {
    ...
    <form className="bg-zinc-900 border border-amber-400/30 rounded-xl p-4 flex flex-col gap-3 mb-3" onSubmit={onSubmit}>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          ...
          <input name="title_en" defaultValue={defaults?.title_en} disabled={pendingOp !== null} className={inputCls} />
        </div>
      </div>
      <div>
