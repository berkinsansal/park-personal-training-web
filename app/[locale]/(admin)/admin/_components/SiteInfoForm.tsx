...
export default function SiteInfoForm({ data }: { data: SiteInfo | null }) {
  ...
  return (
    <section>
      <h2 className="text-white font-bold text-lg mb-4 pb-2 border-b border-zinc-800">
        {t('heading')}
      </h2>
      <form action={action} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        />
        <Field
          label={t('addressLine1En')}
          name="address_line1_en"
          defaultValue={data.address_line1_en}
        />
        <Field
        ...
        />
        <Field
          label={t('addressLine2En')}
          name="address_line2_en"
          defaultValue={data.address_line2_en}
        />
        <Field
          label={t('weekdayHours')}
          name="weekday_hours"
          defaultValue={data.weekday_hours}
        />
        <Field
          label={t('weekdayHoursEn')}
          name="weekday_hours_en"
          defaultValue={data.weekday_hours_en}
        />
        <Field
          label={t('weekendHours')}
          name="weekend_hours"
          defaultValue={data.weekend_hours}
        />
        <Field
          label={t('weekendHoursEn')}
          name="weekend_hours_en"
          defaultValue={data.weekend_hours_en}
        />
        <Field
          label={t('happyCustomers')}
          name="happy_customers"
          type="number"
          defaultValue={String(data.happy_customers)}
        />
        <Field
          label={t('yearsExperience')}
          name="years_experience"
          type="number"
          defaultValue={String(data.years_experience)}
        />
        <Field
          label={t('latitude')}
          name="latitude"
          type="number"
          step="0.00000001"
          defaultValue={String(data.latitude)}
        />
        <Field
          label={t('longitude')}
          name="longitude"
          type="number"
          step="0.00000001"
          defaultValue={String(data.longitude)}
        />
